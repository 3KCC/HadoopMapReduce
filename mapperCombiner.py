...
def mapper():
    ...
    for line in reader:
        # YOUR CODE HERE
        if len(line) == 19:
            p_id, title, tagnames, author_id, body, node_type, parent_id, abs_parent_id, added_at, score = line[:10]
            writer.writerow([author_id, 'B', p_id, title, tagnames, node_type, parent_id, abs_parent_id, added_at, score])
